...
* [varnish/Varnish-Cache](https://github.com/varnish/Varnish-Cache) - Varnish Cache github mirror
...
* [silentbicycle/greatest](https://github.com/silentbicycle/greatest) - A C unit testing library in 1 file. No dependencies, no dynamic allocation. ISC licensed.
...
* [felixangell/mac](https://github.com/felixangell/mac) - MAC - Simple virtual machine in C
...
* [coturn/coturn](https://github.com/coturn/coturn) - Automatically exported from code.google.com/p/coturn
...
* [vim/vim-tryout](https://github.com/vim/vim-tryout) - TRY OUT - cleaned up repository from code.google.com
...
* [WhisperSystems/RedPhone](https://github.com/WhisperSystems/RedPhone) - A secure calling app for Android.
...
* [lepht/licecap](https://github.com/lepht/licecap) - simple animated screen captures
...
* [intel-iot-devkit/mraa](https://github.com/intel-iot-devkit/mraa) - Low Level Skeleton Library for IO Communication on GNU/Linux platforms
...
* [HandBrake/HandBrakeMirror](https://github.com/HandBrake/HandBrakeMirror) - Readonly Mirror of the offical HandBrake svn repository.
...
* [vurtun/json](https://github.com/vurtun/json) - a lightweight ANSI C JSON parser
...
* [cyassl/cyassl](https://github.com/cyassl/cyassl) - CyaSSL is a small, fast, portable implementation of TLS/SSL for embedded devices to the cloud.
...
* [pornel/dssim](https://github.com/pornel/dssim) - DSSIM C implementation
...
* [burke/monkeysupport](https://github.com/burke/monkeysupport) - MonkeyPatching Rails with C since 2009.
...
* [openworm/sibernetic](https://github.com/openworm/sibernetic) - This is a C++ implementation of the Contractile PCI SPH algorithm applied to C. elegans locomotion
...
* [cesanta/frozen](https://github.com/cesanta/frozen) - JSON parser and generator for C/C++
...
* [hit9/todo.c](https://github.com/hit9/todo.c) - :punch: Command line lightweight todo tool with readable storage , written in C.
...
* [contiki/contiki-arduino](https://github.com/contiki/contiki-arduino) - Updated port for Ardunio support (ATmega168 and ATmega328p)
...
* [WizardMac/ReadStat](https://github.com/WizardMac/ReadStat) - C library for reading files from popular stats packages (Stata, SPSS, R...)
...
* [beoran/chipmunk](https://github.com/beoran/chipmunk) - Bindings to Chipmunk 5.3.4 with extra features for use with Ruby 1.8.x and 1.9.x. Version 5.4.3.4 released on rubygems. Just a gem install chipmunk should work, even on windows!
...
* [joan2937/pigpio](https://github.com/joan2937/pigpio) - pigpio is a C library for the Raspberry which allows control of the general purpose input outputs (gpios).
* [hrydgard/native](https://github.com/hrydgard/native) - Various C++ utility code: OpenGL ES, JSON, etc, portable to Android.
...
* [contiki/contiki-mirror](https://github.com/contiki/contiki-mirror) - New official repository:
...
* [trezor/trezor-crypto](https://github.com/trezor/trezor-crypto) - Heavily optimized cryptography algorithms for embedded devices.
...
* [mhroth/tinyosc](https://github.com/mhroth/tinyosc) - A minimal Open Sound Control (OSC) library written in C.
...
* [QCopter/QCopterFlightControl](https://github.com/QCopter/QCopterFlightControl) - 飛控板 FlightController，使用 STM32F405R
...
* [stevedekorte/garbagecollector](https://github.com/stevedekorte/garbagecollector) - Garbage collector library implemented in C for use by high level language implementions.
...
* [Hypsurus/ftpmap](https://github.com/Hypsurus/ftpmap) - FTP scanner, and take-over tool in C
...
* [QuentinPerez/42-toolkit](https://github.com/QuentinPerez/42-toolkit) - It's a lot of dev tools written in C
...
* [dalerank/caesaria-game](https://github.com/dalerank/caesaria-game) - caesaria-game
...
* [otcshare/cordova-win7](https://github.com/otcshare/cordova-win7) - Draft implementation of a Cordova layer for Windows 7.
...
* [willemt/pearldb](https://github.com/willemt/pearldb) - LMDB + H2O = a fast REST key-value database server in C
...
* [mikebmcl/N3888_RefImpl](https://github.com/mikebmcl/N3888_RefImpl) - Reference Implementations of ISO C++ N4073
...
* [Ruslan-B/FFmpeg.AutoGen](https://github.com/Ruslan-B/FFmpeg.AutoGen) - Auto Generated FFmpeg wrapper for C#/.NET and Mono
...
* [igrr/esptool-ck](https://github.com/igrr/esptool-ck) - The ESP8266 build helper tool by Christian Klippel
